...
//    a los métodos doGet(), doPost() cuando se realiza una solicitud al servlet.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        usuarioDAO.insertarLogin(email,password);
        ///crea un nuevo usuario en la tabla registroUsuario
        ///devemos tambien cargar un usuario en la tabla login con su email y su password
        /// o podemos usar la lista completa de registros para validar pero es mas complejo
