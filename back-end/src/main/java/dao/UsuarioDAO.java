...
public class UsuarioDAO {
    ...
    public boolean insertarLogin(String usuarioEmail,String usuarioPassword) {
        String sql = "INSERT INTO login (email, contrasena) VALUES (?, ?)";

        try (Connection conn = ConexionDB.obtenerConexion();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
            
            pstmt.setString(1, usuarioEmail);
            pstmt.setString(2, usuarioPassword);
